...
probabilities = p0 * np.arange(0.01, 10, .1)
...
figname = "../figures/SBM_N"+str(N)

#PLOT 1 - number of ergodic sets

plt.semilogy(results[:,0],results[:,1]/N, label='inputs')
plt.title("Average number of ergodic sets for SBM graphs")
plt.xlabel('p/p_c')
...
plt.semilogy(results[:,0],results[:,5]/N, label='inputs')
plt.semilogy(results[:,0],results[:,6]/N, label='outputs')
plt.title("Total number of vertices in ergodic sets [SBM model] for N="+ str(N))
plt.legend()
plt.xlabel('p/p_c')
plt.tight_layout()
...
plt.semilogy(results[:,0],results[:,7]/N, label='inputs')
plt.semilogy(results[:,0],results[:,8]/N, label='outputs')
plt.title("Propotion of vertices in the largest ergodic sets [SBM model] for N="+ str(N))
plt.legend()
plt.xlabel('p/p_c')
plt.tight_layout()
